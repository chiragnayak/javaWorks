package General.udemy.JVM.reflection;

import java.lang.reflect.Constructor;
import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

import General.udemy.JVM.stringPool.User;
...
public class ReflectionDemo {
	...
	public static void demoClassObjectAccess() {
	    ...
	    Class clazz = null;
	    try {
		    clazz = Class.forName("General.udemy.JVM.stringPool.User");		    
	...
	public static void main(String[] args) throws Exception {
		...
		demoCoreReflection(Class.forName("General.udemy.JVM.stringPool.User"));
	}
}
